...
async def sync_today():
    ...
    shift_column_range(SPREADSHEET_ID, SHEET_NAME, "G3:G6", "C3:C6")
    shift_column_range(SPREADSHEET_ID, SHEET_NAME, "H3:H6", "D3:D6")
    ...
    try:
        ...
        data_rows = df.iloc[1:5] # Get 4 rows of data (skipping metadata row 0)
